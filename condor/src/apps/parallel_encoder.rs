...
use av1an_core::{
    condor::{
        core::processors::{ProcessCompletion, ProcessStatus, Status},
        data::{encoding::Encoder, scene::Scene},
    },
    ClipInfo,
};
use ratatui::{
...
pub struct ParallelEncoderApp {
    ...
    pub scenes:                     BTreeMap<u64, (u64, Scene<CliProcessData>)>,
...
impl ParallelEncoderApp {
    pub fn new(
        workers: u8,
        encoder: Encoder,
        scenes: BTreeMap<u64, (u64, Scene<CliProcessData>)>,
        clip_info: ClipInfo,
    ) -> ParallelEncoderApp {
        ParallelEncoderApp {
...
pub struct SceneEncoder {
    pub scene:            Scene<CliProcessData>,
    pub started:          std::time::Instant,
    pub current_pass:     u8,
    pub total_passes:     u8,
