...
impl Input {
    ...
    #[inline]
    pub fn validate(data: &InputData) -> Result<()> {
        match data {
            InputData::Video {
                path, ..
            } => {
    ...
    #[inline]
    pub fn from_video(data: &InputData) -> Result<Self> {
        match data {
            InputData::Video {
                path,
                import_method,
    ...
    #[inline]
    pub fn from_vapoursynth(data: &InputData, modify_node: Option<ModifyNode>) -> Result<Self> {
        Input::validate(data)?;
        match data {
            InputData::VapourSynth {
                path,
    ...
    #[inline]
    pub fn from_data(data: &InputData) -> Result<Self> {
        match data {
            InputData::Video {
                ..
